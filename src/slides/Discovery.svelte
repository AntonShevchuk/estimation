...
<section>
    <Section>
        ...
        <Notes>
            – Значно більше ніж просто оцінка, це окремий проєкт
        </Notes>
    </Section>
    <Content>
        ...
        <p class="text-center text-xl bottom-4">
            <a href="https://qwiki.nixs.com/x/IoS9Cg">NIX Wiki</a>
        </p>
        <Notes>
            – Це більш схоже на альтернативний flow для точної оцінки, але не виключає його
        </Notes>
    </Content>
    <Caption>
        — Last?<br/>
